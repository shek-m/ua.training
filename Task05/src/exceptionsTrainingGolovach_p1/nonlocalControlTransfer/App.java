package exceptionsTrainingGolovach_p1.nonlocalControlTransfer;

public class App {
    //Передача управления между фреймами стека
...
class App01 {
    //выходим из всех фреймов (автоматически) при вылетании исключении
    public static void main(String[] args) {
        System.err.println("#1.in");
        f(); // создаем фрейм, помещаем в стек, передаем в него управление
...
class App02 {
    /*
        ...
        Cтандартный сценарий работы был восстановлен в методе main() (фрейм #1)
     */
    public static void main(String[] args) {
        System.err.println("#1.in");
        try {
